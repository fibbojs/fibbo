...
describe("fCollider", () => {
	...
	it("should create a collider with default options", () => {
		...
		expect(rectangle.collider.transform.scaleX).toEqual(
			rectangle.collider.transform.scale.x,
		);
		expect(rectangle.collider.transform.scaleY).toEqual(
			rectangle.collider.transform.scale.y,
		);
		// Validate RAPIER collider
	...
	it("should create a collider with a circle shape", () => {
		...
		expect(rectangle.collider.__COLLIDER__.shape.type).toEqual(
