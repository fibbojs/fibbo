...
describe("fRigidBody", () => {
	...
	it("should create a collider with default options", () => {
		...
		expect(rectangle.rigidBody.transform.scaleX).toEqual(
			rectangle.rigidBody.transform.scale.x,
		);
		expect(rectangle.rigidBody.transform.scaleY).toEqual(
			rectangle.rigidBody.transform.scale.y,
		);
		// Validate RAPIER rigidBody
		validateRapierRigidBody(
			rectangle.rigidBody.__RIGIDBODY__,
			rectangle.rigidBody.transform,
		);
	});
	...
	it("should create a collider with a circle shape", () => {
		...
		expect(rectangle.rigidBody.collider.__COLLIDER__.shape.type).toEqual(
