...
describe('fRigidBody', () => {
  ...
  it('should create a collider with default options', () => {
    ...
    expect(cuboid.rigidBody.transform.scaleX).toEqual(cuboid.rigidBody.transform.scale.x)
    expect(cuboid.rigidBody.transform.scaleY).toEqual(cuboid.rigidBody.transform.scale.y)
    expect(cuboid.rigidBody.transform.scaleZ).toEqual(cuboid.rigidBody.transform.scale.z)
    // Validate RAPIER rigidBody
    validateRapierRigidBody(cuboid.rigidBody.__RIGIDBODY__, cuboid.rigidBody.transform)
  })
  ...
  it('should create a collider with custom transforms', () => {
    ...
    expect(cuboid.rigidBody.offset.rotation).toEqual({ x: -0.3, y: 0.2, z: 0.1 })
    expect(cuboid.rigidBody.collider.offset.scale).toEqual({ x: 2, y: 2, z: 2 })
    // Validate transforms
